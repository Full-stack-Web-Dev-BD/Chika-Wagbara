  ...
  return (
    <div className="table-data">
      <div className="d-flex">
        <h2 className="mb3" style={{float:'left', marginTop:18}}>Accession</h2>
        <div className="d-inline ml-auto">
          <div className="select-test" style={{marginTop:-10}}>
            <TextField
                ...
                size="small"
              >
                <option selected disabled hidden >Select Accession</option>
                <option value="true">Accessed</option>
        ...
        <PerfectScrollbar>
          <Box minWidth={1050}>
            <Table size="small">
              ...
              <TableBody>
                {allPatientTest?
                allPatientTest.map((el, i) => {
                  return(
                    <>
                    {
                      el.tests?
                      el.tests.map((data, index)=>(
                        <TableRow
                          hover
                        ...
                        >  
                          ...
                          <TableCell>
                            ...
                            >
                              <Typography
                                aria-owns={PatientPopOverOpen ? (i+1) : undefined}
                                aria-haspopup="true"
                                onMouseEnter={(e)=>handlePatientPopoverOpen(e, i+1)}
                          ...
                          <TableCell>
                            <Button className="pop-button" aria-describedby={id} onClick={(e)=>handleClick(e, i+1)}>
                              <MoreVertIcon />
                            </Button>
                            <Popover
                              id={popId}
...
export default connect(mapStateToProps, { getPatientTests, deletePatientTest })(AccessionTable);
